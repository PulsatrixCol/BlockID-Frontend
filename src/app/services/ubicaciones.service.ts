...
export class UbicacionesService {
  ...
  constructor() {  }
	...
	getDepartamentos() {
		return this.colombia.map(departamento => {
			return {nombre: departamento.departamento, id: departamento.id}
		});
	}

	getPaises(){
		return this.mundo.map(pais => {
			return {nombre: pais.name, id: pais.id}
		});
	}

	getCiudades(nombreDepartamento:string) {
		return this.colombia.filter(departamento => {
